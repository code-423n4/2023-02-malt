...
The Malt Swing Trader can purchase Malt below its intrinsic value eg it may spend <span><span>$</span></span>0.9 on something it can afford to spend <span><span>$</span></span>1 to purchase. This <span><span>$</span></span>0.1 delta leaves more collateral relative to the supply it just removed. Thus improving the global collateral ratio for the remaining circulating supply.
